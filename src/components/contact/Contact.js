            ...
            <div  className="contact px-16 lg:px-0 pt-16 lg:pb-8">
                <div className="contact-section max-w-full mx-auto grid grid-cols-1 lg:grid-cols-3 lg:space-x-20">
                    ...
                    <form>
                        ...
                        <button type="submit" className="text-white bg-transparent shadow-md shadow-orange-600 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">Submit</button>
                    </form>
                    </div>
                    ...
                    <div className=' text-orange-600 flex flex-col items-left lg:justify-center py-8 lg:py-0 lg:mt-20'>
                        ...
                        <div>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="mr-3 h-6 sm:h-9" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <span className="self-center text-lg font-semibold whitespace-nowrap dark:text-white">a.subekhiahmad@gmail.com</span>
                            </a>
                        </div>
                        <div>
                            <a href="#" className="flex items-center">
                            ...
                            <span className="self-center text-lg font-semibold whitespace-nowrap dark:text-white">+6285156022153</span>
                            </a>
                        </div>
                        <div>
                            <a href="#" className="flex items-center">
                            ...
                            <span className="self-center text-lg font-semibold whitespace-nowrap dark:text-white">Luwu Timur, South Sulawesi, <br /> Indonesia - 92975</span>
                            </a>
                        </div>
                        </div>
                       ...
                       <div className='flex items-center justify-center lg:justify-start'>
                        ...
                        <div className=' bg-orange-600 rounded-full h-14 w-14 flex items-center justify-center'>
                            <a href="https://www.linkedin.com/in/subekhiahmad/"><img src={linked} alt="linked" className=' h-10 w-10'/></a>
                        </div>  
                        <div className=' bg-orange-600 rounded-full h-14 w-14 flex items-center justify-center'>
                            <a href="#"><img src={git} alt="git"  className=' h-10 w-10' /></a>
                        </div>
                        <div className=' bg-orange-600 rounded-full h-14 w-14 flex items-center justify-center'>
                            <a href="#"><img src={twitter} alt=""  className=' h-10 w-10' /></a>
                        </div>
                    ...
                    <div className=' flex items-end justify-end hidden lg:flex'>
                        <img src={ThemeContact} alt="ilustration-laslesvpn" className=' w-60 h-auto' />
                    </div>
