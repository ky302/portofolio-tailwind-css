        ...
        <main id='home' className='home bg-neutral-900'>
            <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 py-20 text-white">
                <div className=' flex items-center justify-center mb-5'>
                    <img src={ProfileImg} alt="profile" className=' w-52 lg:w-96 h-auto rounded-full border-orange-600 border-4' />
                </div>
            ...
            <div className="about">
                <div className="container max-w-5xl mx-auto grid lg:grid-cols-2 sm:grid-cols-1 py-10 lg:py-20">
                    <div id='about' className="about-description text-white px-16 lg:px-0">
                        <h2 className=' text-5xl lg:text-6xl font-bold text-orange-600 py-10 text-center lg:text-left'>{AboutData.title}</h2>
                        <p className=' indent-8 text-lg text-justify'>{AboutData.description1}<br/><br/>{AboutData.description2}</p>
                    </div>
                    <div className='flex items-center justify-center hidden lg:flex'>
                        <img src={ThemeOrng} alt="ilustration-laslesvpn" className=' w-52 lg:w-80 h-auto ml-20' />
                    </div>
                </div>
            </div>
