...
const Project = () => {
    const projectData = [
        {
            title: 'Film Website',
            describe: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ex, modi.',
            image : film
  ...
  return (
    ...
    <h1 id='project' className=' text-5xl text-orange-600 flex items-center justify-center font-bold py-8 '>Project</h1>
